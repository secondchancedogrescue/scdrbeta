        ...
        <div className='desktop-home tw-my-10 tw-px-4'>
          ...
          <div className='tw-gap-0 tw-grid tw-grid-cols-2 tw-my-16 tw-mx-auto tw-max-w-[400px]'>
            ...
            <div className='tw-aspect-square tw-flex tw-justify-center tw-items-center tw-p-4 tw-border-b-4'>
              <img className='tw-h-auto tw-w-full tw-max-w-[200px] tw-max-h-[200px] tw-object-contain]' src="https://secondchancedogrescue.org/wp-content/uploads/2025/03/Grant-Badge-3-1024x1024.gif" alt="" />
            </div>
            ...
            <div className='tw-aspect-square tw-flex tw-justify-center tw-items-center tw-p-4'>
              <img className='tw-h-auto tw-w-full tw-max-w-[200px] tw-max-h-[200px] tw-object-contain' src="https://secondchancedogrescue.org/wp-content/uploads/2025/03/Full-Color-Logo-For-Pets.-For-People.-For-Good-1.png" alt="" />
            </div>
          </div>
        </div>
      </section>
